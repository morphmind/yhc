          ...
          <div className="relative overflow-hidden rounded-2xl p-6 bg-white/80 dark:bg-white/5 backdrop-blur-md border border-black/[0.08] dark:border-white/[0.08] shadow-[0_1px_2px_rgba(0,0,0,0.05)] dark:shadow-[0_1px_2px_rgba(255,255,255,0.05)] transition-all duration-300 hover:shadow-[0_8px_16px_rgba(0,0,0,0.1)] dark:hover:shadow-[0_8px_16px_rgba(255,255,255,0.1)]">
            <div className="flex items-center gap-4 mb-4">
              ...
              <div className="flex-1 min-w-0">
                <h3 className="text-lg font-semibold truncate text-foreground dark:text-white">Dr. Mustafa Yakışıklı</h3>
                <p className="text-sm text-foreground/60 dark:text-white/60">{t.home.hero.whyUs.doctorTitle}</p>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between text-sm">
              <div className="flex items-center gap-2 text-foreground/80 dark:text-white/80">
                ...
                <span className="font-medium text-xs">{t.home.hero.whyUs.stats.certificates}</span>
              </div>
              <div className="flex items-center gap-2 text-foreground/80 dark:text-white/80">
                <Users className="w-4 h-4 text-primary dark:text-white" />
                <span className="font-medium text-xs">{t.home.hero.whyUs.stats.operations}</span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="space-y-6">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/80 dark:bg-white/10 backdrop-blur-md border border-black/[0.08] dark:border-white/[0.08] shadow-[0_2px_8px_rgba(0,0,0,0.04)] dark:shadow-[0_2px_8px_rgba(255,255,255,0.04)] transition-all duration-300 hover:scale-[1.02]">
                ...
                <span className="text-sm font-medium text-foreground/80 dark:text-white/80">{t.home.hero.whyUs.doctorTitle}</span>
              </div>
              <h2 className="text-4xl sm:text-5xl !leading-[1.2] font-bold text-foreground dark:text-white">Dr. Mustafa Yakışıklı</h2>
              ...
              <div className="flex flex-wrap gap-4">
                <div className="flex items-center gap-2 text-foreground/80 dark:text-white/80">
                  ...
                  <span className="text-sm font-medium whitespace-nowrap tracking-tight">{t.home.hero.whyUs.stats.certificates}</span>
                </div>
                <div className="flex items-center gap-2 text-foreground/80 dark:text-white/80">
                  <Users className="w-5 h-5 text-primary dark:text-white" />
                  <span className="text-sm font-medium whitespace-nowrap tracking-tight">{t.home.hero.whyUs.stats.operations}</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="grid md:grid-cols-2 gap-4 md:gap-8 mb-8 md:mb-16">
          ...
          <div className="relative overflow-hidden rounded-2xl p-6 md:p-8 bg-white/80 dark:bg-white/5 backdrop-blur-md border border-black/[0.08] dark:border-white/[0.08] shadow-[0_1px_2px_rgba(0,0,0,0.05)] dark:shadow-[0_1px_2px_rgba(255,255,255,0.05)] transition-all duration-300 hover:shadow-[0_8px_16px_rgba(0,0,0,0.1)] dark:hover:shadow-[0_8px_16px_rgba(255,255,255,0.1)]">
            <div className="flex items-center gap-3 mb-4 md:mb-6">
              ...
              <h3 className="text-xl md:text-2xl font-semibold text-foreground dark:text-white">{t.home.hero.whyUs.clinic.title}</h3>
            </div>
              ...
              {t.home.hero.whyUs.clinic.features.map((feature, index) => (
                <li key={index} className="flex items-start gap-3">
                  <div className="w-6 h-6 rounded-full bg-white dark:bg-white/10 shadow-[0_1px_2px_rgba(0,0,0,0.05)] dark:shadow-[0_1px_2px_rgba(255,255,255,0.05)] flex items-center justify-center flex-shrink-0 mt-0.5">
                    <span className="text-primary dark:text-white text-sm font-medium">{index + 1}</span>
                  </div>
                  <p className="text-sm md:text-base text-foreground/60 dark:text-white/60 leading-relaxed">{feature}</p>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div className="relative overflow-hidden rounded-2xl p-6 md:p-8 bg-white/80 dark:bg-white/5 backdrop-blur-md border border-black/[0.08] dark:border-white/[0.08] shadow-[0_1px_2px_rgba(0,0,0,0.05)] dark:shadow-[0_1px_2px_rgba(255,255,255,0.05)] transition-all duration-300 hover:shadow-[0_8px_16px_rgba(0,0,0,0.1)] dark:hover:shadow-[0_8px_16px_rgba(255,255,255,0.1)]">
            <div className="flex items-center gap-3 mb-4 md:mb-6">
              ...
              <h3 className="text-xl md:text-2xl font-semibold text-foreground dark:text-white">{t.home.hero.whyUs.certifications.title}</h3>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              ...
              <div className="flex items-center gap-3 p-4 rounded-xl bg-white dark:bg-white/10 shadow-[0_1px_2px_rgba(0,0,0,0.05)] dark:shadow-[0_1px_2px_rgba(255,255,255,0.05)] transition-all duration-300 hover:shadow-[0_4px_8px_rgba(0,0,0,0.1)] dark:hover:shadow-[0_4px_8px_rgba(255,255,255,0.1)]">
                ...
                <div>
                  <p className="font-medium text-foreground dark:text-white">{t.home.hero.whyUs.certifications.items.jci}</p>
                  <p className="text-xs text-foreground/60 dark:text-white/60 mt-0.5">Joint Commission International</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3 p-4 rounded-xl bg-white dark:bg-white/10 shadow-[0_1px_2px_rgba(0,0,0,0.05)] dark:shadow-[0_1px_2px_rgba(255,255,255,0.05)] transition-all duration-300 hover:shadow-[0_4px_8px_rgba(0,0,0,0.1)] dark:hover:shadow-[0_4px_8px_rgba(255,255,255,0.1)]">
                ...
                <div>
                  <p className="font-medium text-foreground dark:text-white">{t.home.hero.whyUs.certifications.items.iso}</p>
                  <p className="text-xs text-foreground/60 dark:text-white/60 mt-0.5">Quality Management System</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3 p-4 rounded-xl bg-white dark:bg-white/10 shadow-[0_1px_2px_rgba(0,0,0,0.05)] dark:shadow-[0_1px_2px_rgba(255,255,255,0.05)] transition-all duration-300 hover:shadow-[0_4px_8px_rgba(0,0,0,0.1)] dark:hover:shadow-[0_4px_8px_rgba(255,255,255,0.1)]">
                ...
                <div>
                  <p className="font-medium text-foreground dark:text-white">{t.home.hero.whyUs.certifications.items.ishrs}</p>
                  <p className="text-xs text-foreground/60 dark:text-white/60 mt-0.5">International Society of Hair Restoration Surgery</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3 p-4 rounded-xl bg-white dark:bg-white/10 shadow-[0_1px_2px_rgba(0,0,0,0.05)] dark:shadow-[0_1px_2px_rgba(255,255,255,0.05)] transition-all duration-300 hover:shadow-[0_4px_8px_rgba(0,0,0,0.1)] dark:hover:shadow-[0_4px_8px_rgba(255,255,255,0.1)]">
                ...
                <div>
                  <p className="font-medium text-foreground dark:text-white">{t.home.hero.whyUs.certifications.items.tshd}</p>
                  <p className="text-xs text-foreground/60 dark:text-white/60 mt-0.5">Turkish Society of Hair Restoration</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-8">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/80 dark:bg-white/10 backdrop-blur-md border border-black/[0.08] dark:border-white/[0.08] shadow-[0_2px_8px_rgba(0,0,0,0.04)] dark:shadow-[0_2px_8px_rgba(255,255,255,0.04)] mb-8 transition-all duration-300 hover:scale-[1.02]">
              ...
              <span className="text-sm font-medium text-foreground/80 dark:text-white/80">{t.home.hero.whyUs.satisfaction.title}</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-3 gap-3 mb-8">
            ...
            <div className="relative overflow-hidden rounded-2xl p-6 bg-white/80 dark:bg-white/5 backdrop-blur-md border border-black/[0.08] dark:border-white/[0.08] shadow-[0_1px_2px_rgba(0,0,0,0.05)] dark:shadow-[0_1px_2px_rgba(255,255,255,0.05)] text-center transition-all duration-300 hover:shadow-[0_8px_16px_rgba(0,0,0,0.1)] dark:hover:shadow-[0_8px_16px_rgba(255,255,255,0.1)]">
              ...
              <div className="text-2xl sm:text-3xl font-bold text-foreground dark:text-white mb-1">{t.home.hero.whyUs.satisfaction.stats.rate.value}</div>
              <p className="text-sm text-foreground/60 dark:text-white/60">{t.home.hero.whyUs.satisfaction.stats.rate.label}</p>
            </div>
            ...
            <div className="relative overflow-hidden rounded-2xl p-6 bg-white/80 dark:bg-white/5 backdrop-blur-md border border-black/[0.08] dark:border-white/[0.08] shadow-[0_1px_2px_rgba(0,0,0,0.05)] dark:shadow-[0_1px_2px_rgba(255,255,255,0.05)] text-center transition-all duration-300 hover:shadow-[0_8px_16px_rgba(0,0,0,0.1)] dark:hover:shadow-[0_8px_16px_rgba(255,255,255,0.1)]">
              ...
              <div className="text-2xl sm:text-3xl font-bold text-foreground dark:text-white mb-1">{t.home.hero.whyUs.satisfaction.stats.patients.value}</div>
              <p className="text-sm text-foreground/60 dark:text-white/60">{t.home.hero.whyUs.satisfaction.stats.patients.label}</p>
            </div>
            ...
            <div className="relative overflow-hidden rounded-2xl p-6 bg-white/80 dark:bg-white/5 backdrop-blur-md border border-black/[0.08] dark:border-white/[0.08] shadow-[0_1px_2px_rgba(0,0,0,0.05)] dark:shadow-[0_1px_2px_rgba(255,255,255,0.05)] text-center transition-all duration-300 hover:shadow-[0_8px_16px_rgba(0,0,0,0.1)] dark:hover:shadow-[0_8px_16px_rgba(255,255,255,0.1)]">
              ...
              <div className="text-2xl sm:text-3xl font-bold text-foreground dark:text-white mb-1">{t.home.hero.whyUs.satisfaction.stats.rating.value}</div>
              <p className="text-sm text-foreground/60 dark:text-white/60">{t.home.hero.whyUs.satisfaction.stats.rating.label}</p>
            </div>
          </div>
