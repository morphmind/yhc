...
export default function AfroHairTransplantPage() {
  ...
  // Update meta tags
  React.useEffect(() => {
    document.title = t.afroHairTransplant.meta.title;
    document.querySelector('meta[name="description"]')?.setAttribute('content', t.afroHairTransplant.meta.description);
    document.querySelector('meta[name="keywords"]')?.setAttribute('content', t.afroHairTransplant.meta.keywords);
  }, [t.afroHairTransplant.meta]);
