...
BEGIN
  ...
  PERFORM insert_translation_with_namespace('en', 'home.hero.whyUs.satisfaction.stats.rate.value', 'value', '98%');
  PERFORM insert_translation_with_namespace('en', 'home.hero.whyUs.satisfaction.stats.rate.label', 'label', 'Patient Satisfaction Rate');
  PERFORM insert_translation_with_namespace('en', 'home.hero.whyUs.satisfaction.stats.patients.value', 'value', '15K+');
  PERFORM insert_translation_with_namespace('en', 'home.hero.whyUs.satisfaction.stats.patients.label', 'label', 'Happy Patients');
  PERFORM insert_translation_with_namespace('en', 'home.hero.whyUs.satisfaction.stats.rating.value', 'value', '4.9/5');
  PERFORM insert_translation_with_namespace('en', 'home.hero.whyUs.satisfaction.stats.rating.label', 'label', 'Patient Rating');

  -- Satisfaction Stats - Turkish
  PERFORM insert_translation_with_namespace('tr', 'home.hero.whyUs.satisfaction.stats.rate.value', 'value', '98%');
  PERFORM insert_translation_with_namespace('tr', 'home.hero.whyUs.satisfaction.stats.rate.label', 'label', 'Hasta Memnuniyet Oranı');
  PERFORM insert_translation_with_namespace('tr', 'home.hero.whyUs.satisfaction.stats.patients.value', 'value', '15K+');
  PERFORM insert_translation_with_namespace('tr', 'home.hero.whyUs.satisfaction.stats.patients.label', 'label', 'Mutlu Hasta');
  PERFORM insert_translation_with_namespace('tr', 'home.hero.whyUs.satisfaction.stats.rating.value', 'value', '4.9/5');
  PERFORM insert_translation_with_namespace('tr', 'home.hero.whyUs.satisfaction.stats.rating.label', 'label', 'Hasta Değerlendirmesi');
